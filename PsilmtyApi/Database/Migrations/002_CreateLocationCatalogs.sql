CREATE TABLE IF NOT EXISTS countries (
    ...
    KEY ix_countries_active_name (is_active, name),
...
CREATE TABLE IF NOT EXISTS states (
    ...
    KEY ix_states_country_active_name (country_id, is_active, name),
...
CREATE TABLE IF NOT EXISTS neighborhoods (
    ...
    KEY ix_neighborhoods_state_active_name (state_id, is_active, name),
